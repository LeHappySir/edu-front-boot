...
import com.lagou.edu.pay.client.dto.*;
import com.lagou.edu.pay.client.enums.Channel;
import com.lagou.edu.pay.client.remote.OrderRemoteService;
...
public class PayServiceImpl implements PayService {
	...
	public PayResVo saveOrder(PayReqVo reqVo) {
		...
		ResponseDTO<PayResDTO> payResDTOResp = payRemoteService.saveOrder(CoverUtil.cover(reqVo, PayReqDTO.class));
		...
		return CoverUtil.cover(payResDTOResp.getContent(), PayResVo.class);
	}
    ...
    */
	...
	public OrderVo getPayResult(Integer userId, String orderNo) {
		...
		return CoverUtil.cover(orderDTO, OrderVo.class);
	}
